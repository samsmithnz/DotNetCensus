...
namespace DotNetCensus.Core
{
    public static class ProjectScanning
    {
        ...
        public static RepoDirectory CreateRepoDirectoryStructure(List<Project> projects)
        {
            ...
            foreach (Project project in projects)
            {
                ...
                else
                {
                    ...
                    {
                        baseDir.Directories.Add(ProcessDirectory(dirQueue));
                    }
                    else
                    {
                        ...
                        RepoDirectory repoDirectory = ProcessDirectory(dirQueue);
                        if (baseDir2 != null)
                        {
        ...
        private static RepoDirectory ProcessDirectory(Queue<string> dirQueue)
        {
            ...
            {
                repoDirectory.Directories.Add(ProcessDirectory(dirQueue));
            }
