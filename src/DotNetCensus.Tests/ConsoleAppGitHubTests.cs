...
public class ConsoleAppGitHubTests : RepoBasedTests
{
    [TestMethod]
    public void RunResultsWithTotalsFromGitHubRepoTest()
    {
        //Arrange
...
";
    ...
    [TestMethod]
    public void RunResultsWithTotalsFromGitHubOrgTest()
    {
        //Arrange
        if (GitHubId != null && GitHubSecret != null)
        {
            string[] parameters = new string[] { "-o", "SamSmithNZ-dotcom",
                "-u", GitHubId,
                "-p", GitHubSecret,
                "-t" };
            StringWriter sw = new();
